...
<html>
	...
	<body>
	     <header class="main-header container">
          	<h1 class="title-adm">Submissões</h1>
		...
		<div class="container main-content ">
			...
			<div class="alert col-md-12" >
				...
				<table class="table table-striped">
					...
					<?php 
				        	$command = "SELECT * FROM atividade ORDER BY id DESC";
						    try {
					    ...
					    <?php }   } else{ echo "<h3 style='margin-bottom:30px; color:#999'>Nenhuma submissão ainda...</h3>";}?>
			        </tbody>
			      </table>
			  </div>
			</div>
