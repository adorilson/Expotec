        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-8 alert">
                    <h1 class="title"> Submissão de Proposta de Minicursos </h1>
                    <!-- formulário de submissão -->
                 <form action="../../../php/functions.php?Atividade=minicurso&User=<?php echo $user; ?>" method="post">
                            <div class="div-form">
                                <label >Título:</label>
                                <input name="titulo" type="text" class="form-control inputNorm" required placeholder="Título do minicurso...">   
                            </div>
                            ...
                            <div id="pre-requisitos" class="div-form alert-success">
                                ...
                                <textarea name="prerequisitos" class="resumo"  rows="5" placeholder="Pré-requisitos para este minicurso" ></textarea>
                            </div> 
                           
                           
                            <div class="div-form">
                                <label for="resumo">Descrição:</label>
                                <textarea name="resumo" class="resumo"  rows="5" placeholder="Forneça um breve resumo do minicurso proposto..." required></textarea>
                            </div>
